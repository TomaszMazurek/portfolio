...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <Paragraph>
        This website’s role is to express me as a programmer. It came into being
        in raw, basic form, but going to evolve into something more complex and
        sophisticated. If time will let me do this. Currently it holds only
        three sections :
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        publish in seperate sections on website. For example web-based material
        editor is working right now but to publish it in here, first i would
        have to integrate with React. Editor is using google’s dat.gui library
        and im my opition it would look silly to use it with React. As soon as I
        make UI with React for this app I will put it here on this website. The
        same goes for all projects capable of working in browser. For those of
        which are not capable of working in browser, like for example Unreal
        Engine projects, I will provide executables to download and launch on
        local machine.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        <Text strong>Material Editor</Text> – Early version of material editor.
        I was able to plug it into the website thanks to Django. Because of
        rather big library of maps and cubic textures, initial loading time may
        be unacceptable for less patient users. After being stored in browser
        cache, subsequent loadings are several times faster.
      </Paragraph>
      <Paragraph>
        ...
        <ul>
          ...
          <li>
            <Text strong>x3dom</Text> - 3D objects created by me, embedded into
            DOM of this website. Might need new section.
          </li>
        </ul>
      </Paragraph>
      <Divider />
      ...
      <Paragraph>
        ...
        every time i change some part of code may be really annoying. After some
        time I’ve rewriten its code, expanded and used it in my bachelor thesis
        which was about material and light in computer graphics. Application was
        still limited to use only set of predefined shapes and materials and two
        lighting models – phong and pbr. Then I realized that this is a
        boilerplate which can be extended in many ways. Even though some of them
      ...
      <Paragraph>
        ...
        />
        <br />
        This how this "boilerplate" looks like. As we can see UI is divided into
        sections. Every section consists of properties which are applied to
        objects in the scene. Objects uses different lighting models to allow
      ...
      <Paragraph>
        ...
        section here. It will take some time because even though i have working
        template that needs only to plug functionality, it still need to be
        integrated with website. This may force me to rewrite either this
        website's logic and/or routing or editor's.
        <br />
        <br />
        <img
          style={{ display: "block", margin: "auto" }}
      ...
      <Paragraph>
        ...
        capabilities of webRTC technology. Simple yet useful. I want to give it
        a section on this website.
      </Paragraph>
      <Divider />
      ...
      <Paragraph>
        <video
          ...
          style={{ display: "block", margin: "auto" }}
        >
          <source src={UE4_RPG_Shooter} type="video/mp4" />
      ...
      <Paragraph>
        <video
          ...
          style={{ display: "block", margin: "auto" }}
        >
          <source src={Unity_VRSpaceShooter} type="video/mp4"></source>
          Your browser does not support HTML video.
        </video>
      </Paragraph>
      <Divider />
      ...
      <Paragraph>
        ...
        />
        <br />
        As we can see, pirate ship patrol given area and try to pursue the cargo
        ship when overlaps it at some determined distance. At the same time,
        cargo ship reacts to this pursuit. It start to escape when pirate ship
        overlaps determined area around the ship. Every cargo ship has unique
        detection area and move with different speed. As it was experiment it is
        not intended to be developed further.
      </Paragraph>
      <Divider />

      <Title level={3}>Train_O_Matic. Ticket Reservation System – C++/Qt</Title>
      <Paragraph>
        ...
        use it to check train routes, make reservation, buy ticket and print it.
        <br />
        <br />
        <img
          style={{ display: "block", margin: "auto" }}
        ...
        <ul>
          ...
          <li>
            ...
            choosing destination and waypoints. Route seleced this way is passed
            to Ticket section as input
          </li>
          <li>
          ...
          <li>
            <Text strong>Cofnij</Text> - undo changes. Needs history of changes.
          </li>
        </ul>
        Application is supposed to be using some kind of API to get train routes
        and local information. Should also work with printer drivers or send
        printing jobs through the network. It is not finished yet though. Life.
      </Paragraph>
      <Divider />
      ...
      <Paragraph>
        ...
        but at the price of imposing many responsibilities on programmer. It has
        its flaws, and many new languages like Go or Rust are posing as
        substitution for C, but it is not going to be substituted by them
        anytime soon. This project was an excersise in C . It works in terminal,
        have scalable board so theoretically one can play GO with computer.
        Unfortunatelly, because it is using recursive min/max algorithm, the
        bigger the board is, then more computationally expensive.
      </Paragraph>
      <Divider />
      ...
      <Paragraph>
        ...
        it. It has no API of any kind and no documentation. After some googling
        i found Github repository. Went through code and figure out the signals
        it sends.
        <br />
        <br />
        <img
      ...
      <Paragraph>
        ...
        programmed with USBAsp device (pins 1,17,18,19). To write program i was
        using functions of Arduino IDE. Communication tested with 9600 baud and
        115200 baud. At 9600 servo was stuttering so i switched to 115200 -
        Turned out that PCB circuts are to thin to support current needed by DC
        motor. Solved problem by making 7.2V circut bypassing PCB.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        - Problem with serial communication between module and microcontroller.
        When paired they couldnt talk to each other. According to specification
        device had to have default communication parameters set to 9600 baud,
        stop bit set to 1 and parity bit set to 0. After many experiments turned
        out that it has different settings than in documentation. It has 9600
        baud, stop bit set to 1 and parity bit set to 0. After correcting those
        values bluetooth module and microcontroller started to talk to each
        other.
      </Paragraph>
      <Paragraph>
        ...
        Unfortunatelly servo MG946R was not available at that time so i changed
        it to MG996R with almost identical parameters. After solving those
        problem i got all of it working and talking to each other. Car is still
        need some mechanical improvements so i can settle servomechanism in
        front to work with steering column.
      </Paragraph>
